...
# ========================================================= #
def generate__sectorShape( radius=None, origin=[0.0,0.0], th1=0.0, th2=180.0, zoffset=0.0, lc=1.0, zWidth=1.0, \
    ...
    if ( defineVolu ):
        ret            = gmsh.model.occ.extrude( [ (2,surf["sector"])], 0.0, 0.0, zWidth )
        volu["sector"] = ret[1][1]
...
if ( __name__=="__main__" ):
    ...
    generate__sectorShape( radius=1.0, th1=-90.0, th2=+90.0, defineSurf=True, lc=0.05, defineVolu=True )
